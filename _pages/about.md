...
**My research mainly focuses on Trustworthy ML**, especially backdoor attacks and defenses, adversarial attacks and defenses, data privacy, and copyright protection in deep learning. My long-term goal is to **make DL-based algorithms more robust and secure during their full life cycle**. Recently, I focus more on **Trustworthy Large Foundation Models** (*e.g.*, DALL-E and GPT-4). I always **chase for simple yet effective methods** with deep insights or even theoretical supports. My research is supported by the Tsinghua 'Future Scholar' Ph.D. Fellowship.
