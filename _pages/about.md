...
[**A Brief Bio**](): Dr. Yiming Li is currently a Research Fellow at Nanyang Technological University. Prior to this, he was a Research Professor (tenure-track) at Zhejiang University, where he received the Outstanding Junior Faculty Award. He obtained his Ph.D. in Computer Science and Technology (with honors) from Tsinghua University. His research centers on Responsible AI and Technical AI Governance, with a particular focus on AI Security & Safety, AI Copyright Protection, and the human-centred dimensions of AI trustworthiness. His work has been published in leading venues, such as IEEE S&P, USENIX Security, NDSS, ICML, NeurIPS, ICLR, CVPR, IEEE TPAMI, IEEE TIFS, and IJCV, and featured by IEEE Spectrum and MIT Technology Review. He co-drafted a mandatory national standard on AI safety and copyright, and his AI security algorithms have been integrated into the production systems of leading technology companies. His methods for AI agent security and video generation security won the championships of competitions held by NeurIPS and ECCV. He serves as Guest Editor for IEEE TPAMI, Consulting Area Editor for IEEE TIFS, Associate Editor for Pattern Recognition, Area Chair for CVPR, ICLR, ICML, NeurIPS, and KDD, and Program Committee Member for IEEE S&P, CCS, and USENIX Security. His honors include the Best Paper Award at PAKDD, the Rising Star Award at WAIC, the KAUST Rising Stars in AI, the 2025 Elsevier–Stanford World's Top 2% Scientists list, and the Forbes 30 Under 30 Asia List (2026). 
