...
[**A Brief Bio**](): Dr. Yiming Li is currently a Research Fellow at Nanyang Technological University. He was previously a tenure-track Research Professor at Zhejiang University, where he received the Outstanding Junior Faculty Award, and he obtained his Ph.D. with honors in Computer Science and Technology from Tsinghua University. His research centers on Responsible AI and Technical AI Governance, with an emphasis on AI security and safety, AI copyright protection, and the human-centered dimensions of AI trustworthiness. His work has appeared in leading venues including IEEE S&P, USENIX Security, NDSS, ICML, NeurIPS, ICLR, CVPR, IEEE TPAMI, IJCV, IEEE TIFS, and IEEE TDSC, and has been covered by MIT Technology Review, IEEE Spectrum, and WIRED. He co-drafted a mandatory national standard on AI safety and copyright, and his AI security algorithms have been deployed in the production systems of leading technology companies. His methods for AI agent security and video generation security won first place in competitions held at NeurIPS and ECCV. His editorial service includes Guest Editor for IEEE TPAMI, Consulting Area Editor for IEEE TIFS, and Associate Editor for Pattern Recognition. He also serves as an Area Chair for CVPR, ICLR, ICML, NeurIPS, and KDD, and as a Program Committee member for IEEE S&P, CCS, and USENIX Security. His honors include the PAKDD Best Paper Award, the WAIC Rising Star Award, the KAUST Rising Stars in AI, inclusion in the 2025 Elsevier and Stanford World's Top 2% Scientists list, and the Forbes 30 Under 30 Asia list (2026). 
